...
class TipoHabCama(Base):
    """Model for representing the relationship between room types and bed types,
    including the number of beds of a specific type in a room type."""
